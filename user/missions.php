...
$ALL_MISSIONS = [
    ...
    ['slug'=>'lifetime_100_videos', 'category'=>'lifetime', 'title'=>'Penonton Sejati',             'desc'=>'Tonton total 100 video di TontonCuan.',       'target'=>100, 'reward'=>10000, 'icon'=>'ph-popcorn'],
...
.wd-top {
  ...
  position: relative; padding: 16px 14px 20px; border-bottom: 3px solid #0284c7;
}
...
.ms-hero-badge { background: rgba(255,255,255,0.2); border: 2px solid rgba(255,255,255,0.4); border-radius: 14px; padding: 6px 12px; text-align: center; }
...
/* ORANGE BODY */
.wd-body { flex: 1; background: #f97316; padding: 14px 14px 100px; position: relative; }
.wd-body::before {
...
/* TABS */
.ms-tabs { display: flex; background: rgba(255,255,255,0.2); border: 2px solid rgba(255,255,255,0.3); border-radius: 10px; padding: 4px; gap: 4px; margin-bottom: 14px; position: relative; z-index: 2; }
.ms-tab { flex: 1; padding: 8px 4px; text-align: center; font-size: 11px; font-weight: 900; color: #fff; background: transparent; border: none; border-radius: 8px; transition: all 0.2s; cursor: pointer; text-shadow: 0 1px 1px rgba(0,0,0,0.2); font-family: 'Nunito', sans-serif; -webkit-tap-highlight-color: transparent; }
.ms-tab.active { background: #fff; color: #c2410c; text-shadow: none; box-shadow: 0 2px 0 rgba(0,0,0,0.1); }

/* SECTION HEADER */
.ms-section-hdr { font-size: 11px; font-weight: 900; color: #fff; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 10px; display: flex; align-items: center; gap: 6px; text-shadow: 0 1px 2px rgba(0,0,0,0.25); position: relative; z-index: 2; }
.ms-section-hdr i { color: #fde047; font-size: 16px; }

/* MISSION CARD */
.ms-card { background: #fff; border: 2.5px solid #1e3a8a; border-radius: 14px; box-shadow: 0 4px 0 #1e3a8a; margin-bottom: 10px; overflow: hidden; transition: opacity 0.3s; position: relative; z-index: 2; }
...
.ms-card__icon { width: 40px; height: 40px; flex-shrink: 0; background: linear-gradient(135deg, #fbbf24, #f59e0b); border: 2px solid #d97706; border-radius: 12px; box-shadow: 0 3px 0 #b45309; display: flex; align-items: center; justify-content: center; font-size: 20px; color: #fff; }
...
.ms-card__reward { background: #fef3c7; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 3px 7px; font-size: 10px; font-weight: 900; color: #d97706; flex-shrink: 0; box-shadow: 0 2px 0 #d97706; }
...
.ms-prog-bar-wrap { height: 10px; background: #dbeafe; border-radius: 6px; overflow: hidden; box-shadow: inset 0 2px 3px rgba(0,0,0,0.08); }
.ms-card--done    .ms-prog-bar-wrap { background: #dcfce7; }
.ms-card--claimed .ms-prog-bar-wrap { background: #f1f5f9; box-shadow: none; }
.ms-prog-bar { height: 100%; background: linear-gradient(90deg, #60a5fa, #2563eb); border-radius: 6px; transition: width 0.5s ease; }
...
/* BUTTONS */
.ms-btn { width: 100%; margin-top: 8px; padding: 9px; border-radius: 10px; font-size: 12px; font-weight: 900; display: flex; align-items: center; justify-content: center; gap: 6px; cursor: pointer; transition: transform 0.1s, box-shadow 0.1s; font-family: 'Nunito', sans-serif; }
