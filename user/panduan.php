...
$panduan_intro    = setting($pdo, 'panduan_intro',      'Cara kerja platform reward video TontonCuan');
...
<div class="pan-top">
  <div class="pan-title"><i class="ph-bold ph-book-open"></i> Panduan TontonCuan</div>
