      ...
      <div class="c-card-body">
        <div class="c-form-group">
          ...
          <input type="text" name="seo_title" class="c-form-control"
                 value="<?= htmlspecialchars($s('seo_title','TontonCuan')) ?>"
                 placeholder="TontonCuan — Nonton Video, Dapat Reward!">
        ...
        <div class="c-form-group">
          <label class="c-label">Meta Author</label>
           <input type="text" name="seo_author" class="c-form-control"
                  value="<?= htmlspecialchars($s('seo_author','TontonCuan')) ?>">
        </div>
        <div class="c-form-group">
    ...
    <div class="c-card" style="border-color:#2563eb22">
      ...
      <div class="c-card-body">
        <div style="font-family:Arial,sans-serif;max-width:400px">
          ...
          <div style="font-size:17px;color:#1a73e8;font-weight:500;margin-bottom:4px" id="preview-title"><?= htmlspecialchars($s('seo_title','TontonCuan')) ?></div>
