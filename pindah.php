...
$new_server_url = 'https://TontonCuan-baru.com'; // Ganti dengan URL server tujuan migrasi Anda
...
<div class="move-server-page">
  ...
  <div class="mv-card">
    ...
    <div class="mv-inner">
      ...
      <div class="mv-desc">
        Untuk kenyamanan dan akses yang lebih ngebut, TontonCuan kini sudah berpindah ke rumah baru yang jauh lebih stabil dan kencang. Yuk gabung ke server baru sekarang!
      </div>
